...
while True:
    ...
    try:                                               # Mencoba menjalankan code yang berguna untuk mencari dan mengambil file dari file system
        ...
        extension = os.path.splitext(filename)[1][1:].lower()                           # Mengambil ekstensi file dari filename yang diberikan
        ...
        ferr = open("404.html", 'r')                                            # Membuka file "404.html" dalam mode baca ('r')
